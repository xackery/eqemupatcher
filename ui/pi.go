...
func RunMyDialog(owner walk.Form) (int, error) {
	...
	dlg.ui.serverListBox.CurrentIndexChanged().Attach(dlg.ui.lb_CurrentIndexChanged)
	dlg.ui.serverListBox.ItemActivated().Attach(dlg.ui.lb_ItemActivated)
